...
export const eventCategoryStyleMap: { [key: string]: { bg: string, text: string } } = {
    ...
    'Nature': { bg: 'bg-green-100 dark:bg-green-900/50', text: 'text-green-800 dark:text-green-300' },
