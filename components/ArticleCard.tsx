  ...
  return (
    ...
    >
      ...
      <div className="flex-grow p-5 flex flex-col">
        ...
        <h3 className="text-lg sm:text-xl font-serif font-bold mt-2 text-charcoal dark:text-slate-200 group-hover:text-brand-green dark:group-hover:text-green-300 transition-colors flex-grow group-hover:underline decoration-brand-green dark:decoration-green-400">{article.title}</h3>
