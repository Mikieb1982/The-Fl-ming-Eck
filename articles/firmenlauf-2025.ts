...
const article: Article = {
  ...
  body: [
    { type: 'paragraph', content: "Bad Belzig saw the 11th edition of its traditional Company Run this Wednesday evening. Held as part of the Burgfestwoche, this year's event was a success, drawing almost 50 teams from local businesses and clubs. Olympic star Heike Drechsler, a familiar face at the event, even participated in the run herself." },
    { type: 'paragraph', content: "Sven Lange, co-organizer from the Krankenkasse Barmer (health insurance company), noted that the final teams were honored around 9:30 PM, right on schedule. He expressed satisfaction that attendance levels are now similar to pre-pandemic times, with a rising trend in recent years." },
